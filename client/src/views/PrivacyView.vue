    ...
    <div class="retro-panel">
      ...
      <div class="retro-panel-content space-y-4">
        ...
        <p class="text-body text-muted-foreground">
          ...
          Google 개인정보 처리방침을 참조하세요.
        </p>

        <h2 class="text-heading font-bold">3. 광고</h2>
        <p class="text-body text-muted-foreground">
          본 서비스는 Google AdSense를 통해 광고를 게재할 수 있으며,
          이 과정에서 쿠키가 사용될 수 있습니다.
        </p>

        <h2 class="text-heading font-bold">4. 문의</h2>
        <p class="text-body text-muted-foreground">
          개인정보 관련 문의:
          <a href="mailto:skdba1313@gmail.com" class="retro-link">skdba1313@gmail.com</a>
        </p>
