...
export const PAYMENT_GATEWAYS: PaymentGatewayMeta[] = [
  ...
  },
  {
    ...
    setupFee: "무료",
    annualFee: "없음",
    cardFee: "영세 1.98% ~ 일반 3.63%",
    settlementCycle: "서비스 정책 확인 필요",
    note: "네이버쇼핑 연동, 주문~배송 관리",
  },
  {
    key: "naverPayment",
    name: "네이버페이 결제형",
  ...
  },
  {
    ...
    setupFee: "무료",
    annualFee: "무료 (이벤트)",
    cardFee: "영세 0.89% ~ 일반 1.72%",
    settlementCycle: "연동 PG 정책에 따름",
    note: "간편결제 위주, PG 통해 연동",
  },
  {
    key: "payco",
    name: "페이코",
