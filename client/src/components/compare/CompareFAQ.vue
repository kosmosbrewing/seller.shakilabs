...
const faqs = [
  {
    ...
    a: "스마트스토어는 카테고리별 수수료가 없고, 주문관리 수수료(1.98~3.63%)와 판매 수수료(2.73%)만 적용됩니다. 현재 반영 데이터에는 네이버쇼핑 유입 2% 추가 수수료 폐지 이후 체계가 포함되어 있습니다.",
  },
  {
  ...
  {
    q: "이 계산기의 수수료는 정확한가요?",
    a: "현재 반영된 공식 수수료 데이터를 기준으로 계산합니다. 다만 프로모션 할인, 광고비, 반품/교환 비용 등은 포함되지 않으므로 실제 정산 금액과 차이가 있을 수 있습니다.",
  },
];
